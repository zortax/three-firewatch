...
local colors = require("three-firewatch.colors")
...
function M.setup()
	...
	theme.highlights = {
		...
		Function = { fg = c.blue5, style = options.styles.functions }, -- function name (also: methods for classes)

		Statement = { fg = c.red }, -- (preferred) any statement
		-- Conditional   = { }, --  if, then, else, endif, switch, etc.
		-- Repeat        = { }, --   for, do, while, etc.
		-- Label         = { }, --    case, default, etc.
		Operator = { fg = c.blue6 }, -- "sizeof", "+", "*", etc.
		Keyword = { fg = c.red, style = options.styles.keywords }, --  any other keyword
		-- Exception     = { }, --  try, catch, 2c323c
		...
		--- Punctuation
		["@punctuation.delimiter"] = { fg = c.blue6 }, -- For delimiters ie: `.`
		["@punctuation.bracket"] = { fg = c.blue6 }, -- For brackets and parens.
		...
		["@string.escape"] = { fg = c.blue6 }, -- For escape characters within a string.
		...
		--- Types
		["@type.builtin"] = { fg = util.darken(c.blue1, 0.95) },
		["@variable.member"] = { fg = c.fg }, -- For fields.
		["@property"] = { fg = c.fg },

		--- Identifiers
		["@variable"] = { fg = c.fg, style = options.styles.variables }, -- Any variable name that does not have another highlight.
		["@variable.builtin"] = { fg = c.blue5 }, -- Variable names that are defined by the languages, like `this` or `self`.
		["@module.builtin"] = { fg = c.blue6 }, -- Variable names that are defined by the languages, like `this` or `self`.

		--- Text
		-- ["@markup.raw.markdown"] = { fg = c.blue },
		["@markup.raw.markdown_inline"] = { bg = c.bg_visual, fg = c.blue },
		...
		NvimTreeGitFileNew = { fg = c.git.add },
		...
		NvimTreeFolderIcon = { bg = c.none, fg = c.fg },
		...
		NeoTreeTabSeparatorActive = { fg = c.fg_gutter, bg = c.bg },
		NeoTreeTabInactive = { fg = c.fg_gutter, bg = c.bg_sidebar },
		NeoTreeTabSeparatorInactive = { fg = c.fg_gutter, bg = c.bg_sidebar },
		...
		IndentBlanklineContextChar = { fg = util.darken(c.fg, 0.8), nocombine = true },
		...
		--- Border
		NotifyERRORBorder = { fg = util.darken(c.error, 0.3), bg = options.transparent and c.none or c.bg_dark },
		NotifyWARNBorder = { fg = util.darken(c.warning, 0.3), bg = options.transparent and c.none or c.bg_dark },
		NotifyINFOBorder = { fg = util.darken(c.info, 0.3), bg = options.transparent and c.none or c.bg_dark },
		NotifyDEBUGBorder = { fg = util.darken(c.comment, 0.3), bg = options.transparent and c.none or c.bg_dark },
		NotifyTRACEBorder = { fg = util.darken(c.purple, 0.3), bg = options.transparent and c.none or c.bg_dark },
		--- Icons
		...
		--- Body
		NotifyERRORBody = { fg = c.fg, bg = options.transparent and c.none or c.bg_dark },
		NotifyWARNBody = { fg = c.fg, bg = options.transparent and c.none or c.bg_dark },
		NotifyINFOBody = { fg = c.fg, bg = options.transparent and c.none or c.bg_dark },
		NotifyDEBUGBody = { fg = c.fg, bg = options.transparent and c.none or c.bg_dark },
		NotifyTRACEBody = { fg = c.fg, bg = options.transparent and c.none or c.bg_dark },
